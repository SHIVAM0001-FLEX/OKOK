    ...
    run: async function (client, message, args) {
        ...
        if (url.match(/^https?:\/\/(www.youtube.com|youtube.com)\/playlist(.*)$/)) {
            ...
            try {
                ...
                let thing = new MessageEmbed()
                    .setAuthor("Playlist has been added to queue", "https://raw.githubusercontent.com/GLITCHEDITZ16/Cloudz Music1/master/assets/Music.gif")
        ...
        async function handleVideo(video, message, channel, playlist = false) {
            ...
            if (!serverQueue) {
                ...
                if (playlist) return;
                let thing = new MessageEmbed()
                    .setAuthor("Song has been added to queue", "https://raw.githubusercontent.com/GLITCHEDITZ16/Cloudz Music1/master/assets/Music.gif")
        ...
        async function play(guild, song) {
            ...
            let thing = new MessageEmbed()
                .setAuthor("Started Playing Music!", "https://raw.githubusercontent.com/GLITCHEDITZ16/Cloudz Music1/master/assets/Music.gif")
                .setThumbnail(song.img)
                .setColor("#FF0000")
                .addField("Name", song.title, true)
                .addField("Duration", song.duration, true)
